...
conn.on('ready', async () => {
  ...
  for (const f of ['client/src/pages/SurveyResponsesPage.jsx', 'client/src/styles.css']) {
  ...
  conn.exec('pm2 restart oprosy && curl -sS http://127.0.0.1:3000/api/health', (e, stream) => {
