...
conn
  .on('ready', async () => {
    try {
      ...
      await mkdirp(sftp, `${REMOTE}/client/src`);
      await put(sftp, path.join(ROOT, 'client/src/styles.css'), `${REMOTE}/client/src/styles.css`);
      console.log('up client/src/styles.css');
